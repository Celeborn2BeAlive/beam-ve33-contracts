import { ZERO_ADDRESS } from "@openzeppelin/test-helpers/src/constants.js";
...
export function checkIsUndeployed(name: string) {
...
export function checkIsDeployed(name: string): Address {
  if (deploymentAddresses[name] === null || deploymentAddresses[name] === undefined) {
