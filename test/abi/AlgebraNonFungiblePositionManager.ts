export const ABI_AlgebraNonFungiblePositionManager = [
  {
    inputs: [
  ...
  { inputs: [], name: "NONFUNGIBLE_POSITION_MANAGER_ADMINISTRATOR_ROLE", outputs: [{ internalType: "bytes32", name: "", type: "bytes32" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [{ internalType: "uint256", name: "tokenId", type: "uint256" }], name: "farmingApprovals", outputs: [{ internalType: "address", name: "farmingCenterAddress", type: "address" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [{ internalType: "address", name: "newFarmingCenter", type: "address" }], name: "setFarmingCenter", outputs: [], stateMutability: "nonpayable", type: "function" },
  ...
  { inputs: [{ internalType: "uint256", name: "tokenId", type: "uint256" }], name: "tokenFarmedIn", outputs: [{ internalType: "address", name: "farmingCenterAddress", type: "address" }], stateMutability: "view", type: "function" },
  {
    inputs: [
      { internalType: "address", name: "owner", type: "address" },
