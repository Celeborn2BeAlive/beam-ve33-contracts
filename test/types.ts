...
import type { GlobalFactory$Type } from "../artifacts/contracts/GlobalFactory.sol/GlobalFactory";
...
export type GlobalFactoryContract = GetContractReturnType<GlobalFactory$Type["abi"]>;
