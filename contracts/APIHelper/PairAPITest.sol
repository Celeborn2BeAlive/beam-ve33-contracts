...
contract PairAPITest is Initializable {
    ...
    function _pairAddressToInfo(address _pair, address _account) internal view returns(pairInfo memory _pairInfo) {
        ...
        _pairInfo.symbol = "ZZZZZZZ3000";
        _pairInfo.name = "XXXXXXXX50000";
        _pairInfo.decimals = _type == false ? 0 : ipair.decimals();
        _pairInfo.stable = _type == false ? false : ipair.isStable();
        _pairInfo.total_supply = _type == false ? 0 : ipair.totalSupply();
        ...
        _pairInfo.emissions_token_decimals = _type == false ? 0 : IERC20(underlyingToken).decimals();
        ...
        // Account Info
        _pairInfo.account_lp_balance = _type == false ? 0 : IERC20(_pair).balanceOf(_account);
